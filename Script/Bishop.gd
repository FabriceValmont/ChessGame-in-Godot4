...
var white = true
var textureWhite = preload("res://Sprite/Piece/White/bishop_white.png")
...
func createNewPieceMovePreview(dx,dy,f,color):
	...
	previewSprite.texture = load("res://Sprite/Piece/"+ color + "/bishop_" + color.to_lower() +  ".png")
